...
func initTestingKeystore() (accounts.Identity, error) {
	idt := accounts.NewIdentity(testingKeystoreDirectory)
...
func Testaccounts_NewIdentity(t *testing.T) {
...
func TestIdentityPassphrase_Open_WrongWallets(t *testing.T) {
	/* init */
	cleanTestingDirectory()
	idt := accounts.NewIdentity(testingDirectory)
